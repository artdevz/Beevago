...
public interface RoomRepository extends JpaRepository<RoomModel, Long> {
    ...
    @Query(nativeQuery = true, value = "SELECT ROOMNUMBER FROM room WHERE HOTELID = :hotelId AND ROOMNUMBER = :roomNumber")
    public Integer findRoomInHotel(UUID hotelId, int roomNumber);    
